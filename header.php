...
<html>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="logout.php" class="btn btn-danger btn-plat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
 ...
 -->          <!-- /.search form -->
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="laphadir.php"><i class="fa fa-book"></i><span>Lap. Daftar Hadir</span></a></li>
            <li><a href="lapbayar.php"><i class="fa fa-money"></i><span>Lap. Pembayaran</span></a></li>
